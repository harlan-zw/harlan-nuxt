...
import type { ContentNavigationItem, ContentSearchSection, PageCollectionItemBase } from '../types'
...
const navigationItem = (page: PageCollectionItemBase, fields: string[]): ContentNavigationItem => {
...
export const createNavigation = (pages: PageCollectionItemBase[], fields: string[] = []): ContentNavigationItem[] => {
...
export const createSurroundings = (pages: PageCollectionItemBase[], path: string, fields: string[] = []): [ContentNavigationItem | null, ContentNavigationItem | null] => {
  ...
  const project = (page?: PageCollectionItemBase) => page
