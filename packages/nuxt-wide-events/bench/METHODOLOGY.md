...
Evlog also retains error messages and stacks. The other error cases retain only `error.name`.
...
The HTTP test builds two identical Nuxt fixtures. One enables the module with console output disabled.
The other does not load the module.
