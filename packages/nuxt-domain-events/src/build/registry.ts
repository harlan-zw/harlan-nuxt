...
export function installEventRegistryTemplates(options: ModuleOptions, nuxt: Nuxt, templateDir: string): void {
  ...
  const typesTemplate = addTypeTemplate({
    filename: 'domain-events/server.d.ts',
...
export function renderEventRegistry(plan: EventRegistryBuildPlan): string {
  ...
  return [
    '/* Generated by @harlan-zw/nuxt-domain-events. Do not edit. */',
    `import { createGeneratedEventRegistry, createGeneratedEventRuntime } from '@harlan-zw/nuxt-domain-events/server'`,
...
export function renderEventServerProxy(): string {
  return [
    ...
    'export async function dispatchEventAndDrain(...args) { return (await loadRuntime()).dispatchEventAndDrain(...args) }',
...
export function renderEventRegistryTypes(plan: EventRegistryBuildPlan): string {
  ...
  return [
    '/* Generated by @harlan-zw/nuxt-domain-events. Do not edit. */',
    `import type { CommitEventPlanResult, DispatchReport, EventCommitUnitOfWork, EventDispatchContext, EventPayloadOf, EventPlan, QueuedDeliveryContext, EventListenerEnvelope } from '@harlan-zw/nuxt-domain-events/server'`,
    '',
    ...
    'export function dispatchEventAndDrain<Name extends EventName>(name: Name, payload: EventPayload<Name>, context?: EventDispatchContext): Promise<DispatchReport>',
...
export function renderEventRegistryContracts(plan: EventRegistryBuildPlan): string {
  ...
  return [
    '/* Generated by @harlan-zw/nuxt-domain-events. Do not edit. */',
    `import type { EventPayloadOf, InputParser, ListenerDefinition, QueuedDeliveryContext } from '@harlan-zw/nuxt-domain-events/server'`,
    '',
    'type EventDefinitions = readonly [',
    ...eventTypes,
    ']',
