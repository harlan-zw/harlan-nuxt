...
| Navigation | A cacheable navigation endpoint, navigation tree, item surroundings, precomputed heading search sections, hidden navigation entries | Navigation queries that decode document ASTs; general-purpose customization not present in scoped content |
